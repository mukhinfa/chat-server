...
type ChatServerV1Client interface {
	...
	Send(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*empty.Empty, error)
...
func (c *chatServerV1Client) Send(ctx context.Context, in *SendMessageRequest, opts ...grpc.CallOption) (*empty.Empty, error) {
	out := new(empty.Empty)
	err := c.cc.Invoke(ctx, "/chat_server_v1.ChatServerV1/Send", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ChatServerV1Server interface {
	...
	Send(context.Context, *SendMessageRequest) (*empty.Empty, error)
...
func (UnimplementedChatServerV1Server) Send(context.Context, *SendMessageRequest) (*empty.Empty, error) {
...
func _ChatServerV1_Send_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendMessageRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ChatServerV1Server).Send(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/chat_server_v1.ChatServerV1/Send",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ChatServerV1Server).Send(ctx, req.(*SendMessageRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ChatServerV1_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "Send",
			Handler:    _ChatServerV1_Send_Handler,
		},
		{
			MethodName: "Delete",
